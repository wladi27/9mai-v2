...
const plans = [
  { period: '7 Días', percentage: 10, days: 7 },
  { period: '30 Días', percentage: 13, days: 30 },
  { period: '90 Días', percentage: 16, days: 90 },
  { period: '180 Días', percentage: 18, days: 180 },
  { period: '360 Días', percentage: 21, days: 360 },
]
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl sm:text-5xl lg:text-6xl font-bold mb-6 tracking-tight text-gray-900">
              ...
              <span className="block text-blue-600">en 9M AI?</span>
            </h2>
              ...
              {plans.map((plan) => (
                ...
                >
                  ...
                  <div className="text-center pt-2">
                    ...
                    <div className="text-sm text-gray-500 mb-1">Rendimiento estimado</div>
            ...
            <CardContent className="p-8">
              <div className="flex flex-col md:flex-row items-start gap-6">
                ...
                <div className="flex-1">
                  <h4 className="text-2xl font-bold mb-4 text-gray-900">Transparencia y Garantía</h4>
                  <p className="text-gray-600 mb-6 border-l-4 border-blue-400 pl-4 py-2">
                    Los porcentajes mostrados son estimaciones orientativas, diseñadas para ilustrar 
                    el potencial del sistema. Los rendimientos reales están sujetos al desempeño del 
                    mercado y la estrategia seleccionada, con mecanismos de gestión de riesgo avanzados 
                    integrados en NovaMind™.
                  </p>
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div className="flex items-center gap-3 p-3 bg-white rounded-lg border border-gray-200">
                      <Check className="w-5 h-5 text-green-500 flex-shrink-0" />
                      <span className="text-sm text-gray-700">Mínimo garantizado según plan</span>
                    </div>
                    <div className="flex items-center gap-3 p-3 bg-white rounded-lg border border-gray-200">
                      <Check className="w-5 h-5 text-green-500 flex-shrink-0" />
                      <span className="text-sm text-gray-700">Sin comisiones ocultas</span>
                    </div>
                  </div>
                </div>
              </div>
